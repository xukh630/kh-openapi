 ...
 */
package com.kh.openapi.common.constants;

/**
 * 项目：liquidator-platform-openapi
 * 包名：com.fshows.liquidator.platform.openapi.common.constants
 * 功能：返回错误的常量
 * 时间：2016-08-02 16:16
 * 作者：Mr.Kiwi
 */
public interface ErrorConstants {
     ...
     * 配置不存在
     */
    String CONFIG_ERROR_CODE = "-224";
    String CONFIG_ERROR_MSG = "配置不存在";
